...
export default function PLClientReportDetailScreen() {
    ...
    }, [entityId, fetchClients, fetchTransactions]);
    ...
    const filtered = useMemo(() => {
        ...
        const base = (transactions || [])
            .filter((tx: any) => toRefId(tx.clientId) === entityId)
...
<body>
  <h1>Client P&L Detail Report</h1>
  <div class="sub">Client: ${escapeHtml(entityName)}</div>
  <div class="meta">
